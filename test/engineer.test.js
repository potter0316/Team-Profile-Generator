...
test('should get the constructor for the engineer', () => {
    ...
    expect(engineer.githubUsername).toBe('potter0316');
});
...
test('should get the if from the getGithubUsername()', () => {
    expect(engineer.getGithubUsername()).toBe('potter0316@gmail.com');
})